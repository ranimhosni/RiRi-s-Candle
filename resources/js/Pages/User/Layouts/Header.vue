        ...
        <div v-if="auth.user" class="relative">
          ...
          <div class="z-50 hidden bg-white dark:bg-gray-800 border border-amber-200 dark:border-gray-700 rounded-xl shadow-xl w-56"
            ...
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="user-menu-button">
              ...
              <li v-if="auth.user.isAdmin" class="border-t border-amber-200 dark:border-gray-700 mt-2 pt-2">
                <Link :href="route('admin.dashboard')"
                  class="flex items-center px-4 py-2.5 text-amber-700 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-900/30 transition-colors duration-200 font-semibold">
